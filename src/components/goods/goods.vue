    ...
    <div class="foods-wrapper" ref="foodsWrapper">
      <ul>
        <li v-for="item in GOODS" class="food-list food-list-hook">
          ...
          <ul>
            <li v-for="food in item.foods" @click="sclectFood(food, $event)" class="food-item border-1px">
              <div class="icon">
                <img :src="food.icon" alt="图片" width="57" height="57">
              </div>
              <div class="content">
...
//        goods: [],
    ...
    computed: {
      ...
      selectFoods() {
        ...
        this.$store.dispatch('selectFoods', foods)
        return foods
      }
    },
    created() {
...
//          this.goods = response.data
          this.$store.dispatch('getGoods', response.data)
          this.$nextTick(() => {
            this._initScroll()
